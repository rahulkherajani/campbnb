...
//SHOW Campgrounds - Show all campgrounds
...
//CREATE Campgrounds- Add new campground
...
//MORE - shows more info about one campground
router.get("/:id", function (req, res) {
    ...
    Campground.findById(req.params.id).populate("comments").exec(function (err, foundCampground) {
        if (err || !foundCampground) {
            ...
            res.render("campgrounds/more", { campground: foundCampground });
        }
    });
});
